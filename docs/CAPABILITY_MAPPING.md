...
| **14** | **Deterministic Artifact Assembly** | `crates/hqe-artifacts/src/builder.rs` | **REPLACED_BY_RUNTIME** | `runtime/artifact_pipeline.py`, `scripts/build_artifacts.py` | `pytest tests/test_runtime.py` |
...
| **16** | **Session Continuity Engine** | `crates/hqe-artifacts/src/session.rs` | **REPLACED_BY_RUNTIME** | `runtime/session_manager.py` | `pytest tests/test_runtime.py` |
...
| **42** | **SQLite / Keyring Persistence** | `crates/hqe-core/src/encrypted_db.rs` | **DROPPED** | None | Replaced by ephemeral JSON session logs |
| **43** | **Provider Client Adapters** | `crates/hqe-openai/` | **DROPPED** | None | Handled natively by host AI runtime |
