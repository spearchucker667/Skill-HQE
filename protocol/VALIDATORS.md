...
| `validate.py` | `hqe-engineer-schema.json` | Enhanced v5.0+ validator with semantic linting |

## Quick Start

```bash
# Validate protocol (v5.0+ enhanced validator)
